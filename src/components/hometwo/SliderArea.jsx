...
const SliderArea = () => {
  ...
  return (
    <section
      ...
      style={{ backgroundImage: 'url("../../img/banner/sports-images-3.png")' }}
    >
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 order-0 order-lg-2">
                {/* <div
                  className="slider-img text-center text-lg-right animate__animated animate__fadeInRight"
                  data-delay="1s"
                >
              ...
              <div className="col-lg-6">
                <div className="banner-content">
                  {/* <h6 className="sub-title" data-delay=".2s">
                    TSports
                  </h6> */}
                  ...
                  <h2
                    ...
                    data-delay=".4s"
                  >
                    FIRST EVER <br></br><span>SPORTS CHANNEL</span><br></br>IN BANGLADESH
                  </h2>
                  <p>A PLATFORM OF UNLIMITED SPORTS CONTENTS</p>

                  {/* <div
                    className="banner-meta animate__animated animate__fadeInUp"
                    data-delay=".6s"
                  >
                    <ul>
                      ...
                      <li className="release-time">
                        <span>
                          <i className="far fa-calendar-alt" /> 2022
                        </span>
                        <span>
